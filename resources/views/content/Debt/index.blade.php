        ...
        @foreach ($debts as $debt)
          <tr data-row-id="{{ $debt->id }}">
            ...
            <td>
              ...
              <a href="{{ route('debt.printer-facteur-client',['debt' => $debt->id, 'fullname' => str_replace('%20', '-', urlencode($debt->fullname))]) }}" target="_blank" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="<i class='bx bx-show me-1'></i> <span>{{ __('View Debt') }}</span>">
