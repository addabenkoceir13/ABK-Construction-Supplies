    ...
    <div class="modal-content shadow-lg border-0">
      <div class="modal-header bg-transparent border-bottom pb-3">
        <div class="d-flex align-items-center gap-2">
          ...
          <h5 class="modal-title mb-0 fw-semibold">{{ __('Add Customer Debt Record') }}</h5>
        </div>
      ...
      <form action="{{ route('debt.store') }}" method="POST">
        ...
        <div class="modal-body py-4">
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-6">
              <label for="fullname-search" class="form-label text-muted small fw-semibold">{{ __('Customer Name') }} <span class="text-danger">*</span></label>
              <div class="input-group input-group-merge">
                <span class="input-group-text bg-lighter"><i class="bx bx-user text-muted"></i></span>
                <input type="text" id="fullname-search" name="fullname" class="form-control @error('fullname') is-invalid @enderror" placeholder="{{ __('Enter Name or search customer...') }}" autocomplete="on" list="listFullName" required />
            ...
            <div class="col-md-6">
              <label for="phone" class="form-label text-muted small fw-semibold">{{ __('Customer Phone') }}</label>
              <div class="input-group input-group-merge">
          ...
          <div class="d-flex justify-content-between align-items-center mb-2 pt-2 border-top">
            <h6 class="mb-0 fw-semibold text-heading d-flex align-items-center gap-1">
              ...
              <span>{{ __('Debt Items & Products') }}</span>
            </h6>
