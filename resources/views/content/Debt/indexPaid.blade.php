...
@section('title', __('Paid Debts'))

@section('content')
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
  <div>
    <h4 class="fw-bold mb-1">
      <span class="text-muted fw-light">{{ __('Debts') }} /</span> {{ __('Paid Debts Archive') }}
    </h4>
    <p class="text-muted mb-0 small">{{ __('Archive of all settled customer debts and payment records.') }}</p>
  </div>
</div>
...
<div class="card shadow-sm border-0">
  <div class="card-header bg-transparent d-flex flex-wrap justify-content-between align-items-center gap-2 py-3">
    <div class="d-flex align-items-center gap-2">
      ...
      <div>
        <h5 class="card-title mb-0 fw-semibold">{{ __('Paid Customer Debts') }}</h5>
