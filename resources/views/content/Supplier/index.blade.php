      ...
      <tbody>
        @foreach ($suppliers as $supplier)
          <tr>
            ...
            <td>
              <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalditSupplier{{ $supplier->id }}">
              ...
              @include('content.Supplier.edit')
              <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalDeleteSupplier{{ $supplier->id }}">
              ...
              @include('content.Supplier.deleted')
            </td>
          </tr>
        @endforeach
      </tbody>
