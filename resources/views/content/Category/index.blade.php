      ...
      <tbody>
        @foreach ($subcategories as $subcategory)
          <tr>
            ...
            <td>
              <button  type="button" class="btn btn-sm btn-none" data-bs-toggle="modal" data-bs-target="#modalEditBuilding{{ $subcategory->id }}">
                <span class="badge bg-label-success"><i class="bx bx-edit-alt me-1"></i></span>
              </button>
              <button type="button" class="btn btn-sm btn-none" data-bs-toggle="modal" data-bs-target="#modalDeleteBuilding{{ $subcategory->id }}">
