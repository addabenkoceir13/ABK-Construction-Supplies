<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
      <a href="{{ route('dashboard-analytics') }}" class="app-brand-link d-flex align-items-center">
          <span class="app-brand-logo demo d-flex align-items-center">
              <img src="{{ asset('assets/logo/abk-bg-transparent.jpeg') }}" alt="ABK Logo" style="height: 38px; width: auto; max-width: 44px; object-fit: contain; border-radius: 8px;">
          </span>
  ...
  <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ request()->routeIs('fuel-stations.*') ? 'active open' : '' }}">
        <a class="menu-link menu-toggle" >
            <i class="menu-icon bx bx-credit-card-front"></i>
            <div>{{ __('Fuel Purchase Accounting') }}</div>
        </a>
        <ul class="menu-sub">
